    ...
    def start(self):
        ...
        if int(int(lvl[3]) / 1000) % 2 == 1:
            ...
            tile_images = {
                ...
                'lisa': load_image('lisa_night.png'),
                'wolf': load_image('wolf_night.png'),
                'kust': load_image('kust_night.png'),
                'verstak': load_image('verstak.png'),
                'koster': load_image('koster.png'),
                'zaiz': load_image('zaiz_night.png'),
                'kust_1': load_image('kust_1_night.png'),
                'kust_2': load_image('kust_2_night.png'),
                'kust_3': load_image('kust_3_night.png'),
                'kust_4': load_image('kust_4_night.png'),
                'kust_5': load_image('kust_5_night.png'),
                'kust_6': load_image('kust_6_night.png'),
                'voda': load_image('voda_night.png'),
